    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        name: null,
        /**
        Primary key of editable object (e.g. record id in database). For composite keys use object, e.g. <code>{id: 1, lang: 'fr'}</code>.
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl 
        **/         
        tpl:'<div class="input-append date">'+
          '<input type="text"/>'+
          '<span class="btn btn-white btn-default btn-small btn-append-date">'+
...
(function ($) {
    ...
    $.extend(DateTime.prototype, {
        initPicker: function(options, defaults) {
            ...
            //language
            this.options.datetimepicker.language = this.options.datetimepicker.language || 'fr'; 
