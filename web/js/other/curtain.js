...
(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        scrollToPosition: function (direction){
            ...
            $('.menu-parallax li').removeClass('current');
            $('.menu-parallax li[data-target="'+(parseInt(index) + 1)+'"]').addClass('current');
        },
        scrollEvent: function() {
            ...
            $('.menu-parallax li').removeClass('current');
            $('.menu-parallax li[data-target="'+self.$current.attr('id')+'"]').addClass('current');
        },
        ...
        setEvents: function() {
            ...
            // Menu perso
            $('.menu-parallax li').on('click', function(e){
              var target = $(this).data('target');
              if(target != null && target != ''){
                self.scrollToPosition(target);
              }
            });
            $('.btn-down i').on('click', function(e){
